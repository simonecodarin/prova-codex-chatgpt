  ...
  <section id="about" class="fade-up mx-auto w-[95%] max-w-6xl py-20">
    ...
    <div class="grid gap-8 md:grid-cols-2">
      ...
      <article class="glass-card rounded-3xl p-8">
        ...
        <p class="mb-4 leading-relaxed text-[var(--text-secondary)]">
          Lavoro con autonomia end-to-end: dalla definizione tecnica al rilascio, curando performance, UX e qualità del codice.
        </p>
        <p class="leading-relaxed text-[var(--text-secondary)]">
          Amo affrontare problemi complessi e trasformarli in soluzioni semplici, manutenibili e orientate al risultato.
        </p>
      </article>
    </div>
  </section>
